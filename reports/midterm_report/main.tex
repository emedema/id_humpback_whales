...
%TODO: refine this.
We will crop, scale, and resize the images such that all of the images are the same size and are only of the tail fin. This will ensure that all of our data is standardize and that we have less variance. We will do this by first converting all images to greyscale as some of the images in the dataset are greyscale and some are colour. In order to even the playing field, we converted all images to greyscale. [Stephen please add what you did]
